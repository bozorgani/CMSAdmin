  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">{isNew ? 'ایجاد دسته‌بندی جدید' : 'ویرایش دسته‌بندی'}</h1>
          <p className="text-gray-600 mt-1">{isNew ? 'دسته‌بندی جدید ایجاد کنید' : 'ویرایش دسته‌بندی'}</p>
        </div>
